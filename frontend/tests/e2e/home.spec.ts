 ...
 *
 * Page sections (frontend_developer.md):
 *   - Hero: headline + search bar with autocomplete
 *   - Popular clinics: horizontal scroll of 6 clinic cards
 *   - Specialties grid: 12 specialty cards with icons
 *   - "How it works": 3 steps
 *   - Popular services: top services with prices
 *   - ChatbotWidget: floating toggle in bottom-right corner
 *
 * data-testid values below are placeholders — update once the
 * frontend developer adds them to the React components.
 *
