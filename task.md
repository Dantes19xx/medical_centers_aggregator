Мне необходимо создать веб-сайт "Сайт выбора поликлиники / медицинских услуг", который будет содержать каталог медицинских учреждений и услуг, со следующим функционалом:

1. Список клиник
2. Страница клиники
3. Услуги
4. Врачи
5. Запись через форму

Нужно написать API backend
Для этой цели используй агента backend_architect
